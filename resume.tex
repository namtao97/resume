...
\section{Experience}
  ...
  \resumeSubhead
      ...
      \resumeItem{Implement a service to get allotment and room rate of hotel room from Hotel Link - The channel management of many hotels and it is the connector between many OTA(Online travel agency) - and show them for booker in website and application.}
      \resumeItem{Maintain and develop Hotel Channel Management: A tool that hotel provider can edit hotel profile, allotments, rate and discount.}
